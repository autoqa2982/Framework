...
/*	public static final String GC_EMPTY = "";
	...
	// FOR CI
	//public static final String GC_EXECUTION_ENVIRONMENT = (System.getProperty("env").toUpperCase() != null) ? System.getProperty("env").toUpperCase() : Stock.getConfigParam("TEST_ENV");
/*	public static final String GC_EXECUTION_ENVIRONMENT = Stock.getConfigParam("TEST_ENV");
	public static final String GC_COLNAME_TEST_ENV = "TEST_ENV";
	// SpreadSheet
	public static final String GC_CONFIGFILEANDSHEETNAME = "testexecutionconfig";
	public static final String GC_DATASHEET_ERR = "Sheet not found";
	...
	public static final String GC_TESTDATALOC = System.getProperty("user.dir")
			+ "\\TestData\\";
	//public static final String GC_COMMON_TESTDATALOC = "H:\\common\\Automation-Selenium\\CSAS\\TestData\\" ;
	...
	public static final String GC_TESTNG_TEST_OUTPUT = System
			.getProperty("user.dir") + "\\test-output";
	public static final String GC_TEST_REPORT_DIR = GC_PROJECT_DIR
			+ "TestReport\\";
	public static final String GC_TEST_REPORT_RESOURCE = GC_PROJECT_DIR
			+ "src\\devresource\\reports\\";
	 ...
	 * Before Using these Remote Output, Input and Archive variables, call
	 * initializeRemoteDirectoryPath() method from SFTP Utils Call to initialize
	 * values
	...
	public static final String GC_REMOTE_ARCHIVE_DIRECTORY = "/work/batch/input/archive/";
	public static final String GC_LOCAL_TEMP_DIRECTORY = "C:\\temp";
	// public static final String GC_LOCAL_TEMP_DIRECTORY =
	...
	static {
		...
		databaseConnectionStrings.put("D_ISIS",
				"jdbc:oracle:thin:@disisdb:1521/disismain.isis.gwl.com");
		...
		databaseConnectionStrings.put("D_QAMA",
				"jdbc:oracle:thin:@gp-ddb2:1521:D_QAMA");
		...
		databaseConnectionStrings.put("Q_CMNM",
				"jdbc:oracle:thin:@qcmnmdb:1521/QCMNMMAIN.ISIS.GWL.COM");
